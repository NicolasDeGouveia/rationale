  ...
  return (
    <div className="p-8 max-w-2xl">
      <div className="mb-6">
        ...
        <p className="text-sm text-neutral-500 mt-1">Workspace and account settings.</p>
      </div>

      <div className="space-y-6">
        {/* Workspace info */}
        <div className="rounded-lg border border-neutral-200 bg-white p-5 space-y-3">
          <h2 className="text-sm font-semibold text-neutral-700">Workspace</h2>
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              <p className="text-xs text-neutral-400 mb-0.5">Your role</p>
        ...
        {/* Members */}
        <div className="rounded-lg border border-neutral-200 bg-white p-5 space-y-3">
          <h2 className="text-sm font-semibold text-neutral-700">Members ({members.length})</h2>
            ...
            {members.map((m) => (
              <li key={m.id} className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <p className="text-sm font-medium text-neutral-800">{m.user.name ?? "Unknown"}</p>
        ...
        <div className="rounded-lg border border-neutral-200 bg-white p-5 space-y-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-neutral-400 mt-0.5">Manage your plan and subscription.</p>
            </div>
